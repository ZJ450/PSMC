...
def get_argument_parser():
    ...
    parser.add_argument('--data_path', default='/data/f30k', help='path to datasets')
    ...
    parser.add_argument('--mu', default=80, type=float)
    parser.add_argument('--gama', default=0.3, type=float)
